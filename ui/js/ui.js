...
UI.messages = {
	help: {
		en: {
			'welcome': '<p class="helpTitle">Welcome to ‡biblios<p class="helpText">Supports searching Z39.50 servers (Search Targets) defined under Options->Search Targets.</p><p class="helpText">Edit monograph records using integrated MARC21 editors (see Editing in sidepanel at left).</p>',
