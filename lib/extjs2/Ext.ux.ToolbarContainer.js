 ...
 */ 
 Ext.ux.ToolbarContainer = function(config){
    ...
    Ext.ux.ToolbarContainer.superclass.constructor.call(this, config);
};

(function(){

var T = Ext.ux.ToolbarContainer;
...
Ext.extend(T, Ext.Container, {
    ...
    addItem : function(item){
    	Ext.ux.ToolbarContainer.superclass.add.apply(this, arguments);
    	return item;
    },
    ...
    insertButton : function(index, item){
        ...
        Ext.ux.ToolbarContainer.superclass.insert.call(this, index, item);
        return item;
    },
...
Ext.reg('toolbar', Ext.ux.ToolbarContainer);
